...
// Dòng thứ 8: khi khai báo Class cls = new Class(): đây là kiểu đối tượng nên nó sẽ tạo đối tượng cls trong heap đồng thời chưa tham chiếu của đối tượng cls1 vào stack (xếp trên cùng trong stack)
