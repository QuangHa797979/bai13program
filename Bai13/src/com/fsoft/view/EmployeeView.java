package com.fsoft.view;

import java.util.Scanner;

import com.fsoft.controllers.EmployeeController;
import com.fsoft.exception.Common;
import com.fsoft.exception.InputNumberException;
import com.fsoft.exception.NameException;

import com.fsoft.exception.BirthDayException;
import com.fsoft.exception.EmailException;
import com.fsoft.exception.PhoneException;

import com.fsoft.entity.Certificate;
import com.fsoft.entity.Employee;

import com.fsoft.entity.Experience;
import com.fsoft.entity.Fresher;
import com.fsoft.entity.Intern;
...
public class EmployeeView {
    ...
    public void viewUpdateEmployee(Employee employee) {
        ...
        if (employee.getEmployeeType().equals(Common.EMPLOYEE_FRESHER)) {
            ...
            System.out.println("7. Pro skill: " + intern.getMajors());
        ...
        if (number == 1) {
            ...
            while (true) {
                try {
                    ...
                    common.checkBirthDay(newBirthDay);
                    break;
                } catch (BirthDayException ex) {
                    System.out.println(ex.getMessage());
                }
